...
| **Finance** | Credit pane for the AI data-center buildout: claimed ~$5T envelope and ~$4T debt (Tunguz), 70% mid-case $3.5T versus the $4T headline, Columbia / Beignet leverage as primary, debt-service waterfall, SIFMA / Fed stocks with a flow-versus-stock caveat, municipal private-use limits. Every USD figure is Cited or Sample. Announcement GW, IT MW, energized MW, OEM slots, and COD are excluded; Forecast Lab is a short cross-link. |
...
### v1.3 — 2026-09-05
- Added **Finance** view: sourced capital stack, debt-service waterfall, credit-market context, municipal channel. Money figures stamp Cited or Sample. Physics units (announcement GW, IT MW, energized MW, OEM slots, COD) are excluded; Forecast Lab is a cross-link only.
