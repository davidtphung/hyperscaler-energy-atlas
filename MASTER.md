...
### v1.3 — 2026-09-05
- Added **Finance** view: sourced capital stack, debt-service waterfall, credit-market context, municipal channel. Money figures stamp Cited or Sample. A labeled Hypergrid bridge keeps committed GW (announcement-electrical `numberKind` only; untagged rows default), status-operational GW, and campus headline GW on separate families; energized MW and COD stay off the credit charts.
