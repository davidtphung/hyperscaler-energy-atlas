...
export const COMMITMENTS: Commitment[] = [
  ...
  },
  {
    ...
    "summary": "Microsoft agreed to buy electricity from Helion Energy's first commercial fusion power plant, targeting at least 50 MW after a one year ramp up, in what both companies call the world's first fusion PPA. Helion's own newsroom says site work has started on the Orion plant near Malaga in Chelan County, Washington, with a 2028 online target. Status stays construction on that statement.",
